    ...
    public class TranslateByGoogle
    {
            ...
            GoogleTranslatedTextReturnEvent endUserFinalTranslationEvent)
        {
            ...
            try
            {
                ...
                this._proxy.StartDownload(crossconnectUrl, this.OpenReadFromCrossConnectCompleted, null);
            }
            catch (Exception eee)
            {
        ...
        private async void DownloadStringFromGoogleCompleted(string error)
        {
            ...
            try
            {
                ...
                string startString = await this._proxy.ReadStorageFileAsyncString();
                string unEscapedText =
                    HttpUtility.HtmlDecode(
                        this.jsonUnescape(Regex.Match(startString, "\"translatedText\" *: *\"(.*?)\"").Groups[1].Value));
        ...
        private async void OpenReadFromCrossConnectCompleted(string message)
        {
            ...
            try
            {
                ...
                int maxtranssize = 0;
                IRandomAccessStream file = await this._proxy.downloadedFile.OpenAsync(FileAccessMode.Read);
                ...
                else
                {
                    ...
                    this._proxy.StartDownload(googleTranslateUrl, this.DownloadStringFromGoogleCompleted, null);
