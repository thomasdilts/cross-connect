...
public class SupportClass
{
    ...
    public class ThreadClass : IThreadRunnable
    {
        ...
        {
            //thomas dilts  threadField.Interrupt();
        }
        ...
        /*  thomas dilts  no existing conversion available
        /// <summary>
        ...
        {
            threadField.Join(new System.TimeSpan(MiliSeconds * 10000).Milliseconds);
        }
        ...
        {
            threadField.Join(new System.TimeSpan(MiliSeconds * 10000 + NanoSeconds * 100).Milliseconds);
        }
...
#pragma warning restore 618
    ...
    {
        static System.Collections.Generic.Dictionary<string, object> settings = new System.Collections.Generic.Dictionary<string, object>();
    ...
    /// <summary>
    /// A Dictionary which holds weak references to its keys so they
    /// can be collected during GC. 
    /// </summary>
    [System.Diagnostics.DebuggerDisplay("Count = {Values.Count}")]
    public class WeakDictionary : Dictionary<object,object>, IEnumerable
    {
        /// <summary>
        /// A weak referene wrapper for the Dictionary keys. Whenever a key\value pair 
        /// is added to the Dictionary, the key is wrapped using a WeakKey. WeakKey saves the
        ...
        /*
        /// <summary>
        /// A Dictionary enumerator which wraps the original Dictionary enumerator 
        /// and performs 2 tasks: Extract the real key from a WeakKey and skip keys
        /// that were already collected.
        /// </summary>
        class WeakDictionaryEnumerator : System.Collections.Generic.Dictionary<object, object>.Enumerator
        {
            System.Collections.Generic.Dictionary<object, object>.Enumerator baseEnumerator;
            object currentKey;
            object currentValue;

            public WeakDictionaryEnumerator(System.Collections.Generic.Dictionary<object, object>.Enumerator baseEnumerator)
            {
        ...
        */
        ...
        /// <summary>
        /// Customize the Dictionary lookup process by overriding KeyEquals. KeyEquals
        /// will compare both WeakKey to WeakKey and WeakKey to real keys
        /// </summary>
        protected bool KeyEquals(object x, object y)
        {
            if (x == y)
                return true;
        ...
        private void Clean()
        {
            foreach (WeakKey wtk in ((Dictionary<object, object>)base.MemberwiseClone()).Keys)
            {
                if (!wtk.IsAlive)
                {
                    Remove(wtk);
        ...
        /// <summary>
        /// Wrap each key with a WeakKey and add it to the Dictionary
        /// </summary>
        ...
        /*
                ...
                {
                     Dictionary<object,object> tmp = null;
                     tmp = (Dictionary<object, object>)base.MemberwiseClone();
                    return (System.Collections.Generic.Dictionary<object,object>.Enumerator)(new WeakDictionaryEnumerator(tmp.GetEnumerator()));
                }
        
                /// <summary>
                /// Create a temporary copy of the real keys and return that
                /// </summary>
                public System.Collections.Generic.Dictionary<object, object>.KeyCollection Keys
                {
                    get
                    {
                        System.Collections.Generic.Dictionary<object, object>.KeyCollection keys = new System.Collections.Generic.Dictionary<object, object>.KeyCollection();
                        Dictionary<object, object> tmpTable = (Dictionary<object, object>)base.MemberwiseClone();
        ...
        public void CopyTo(Array array, int index)
        {
            ...
            {
                array.SetValue(de.Value, arrayIndex++);
            }
        }
    ...
    public class Cryptography
    {
        ...
        static public System.Security.Cryptography.HashAlgorithm GetHashAlgorithm()
        {
            if (FIPSCompliant)
            {
                ...
                return new System.Security.Cryptography.SHA1Managed();//.Create();
            }
    ...
    /// <summary>
    /// Support class used to handle Dictionary addition, which does a check 
    /// first to make sure the added item is unique in the hash.
    /// </summary>
    public class CollectionsHelper
    {
        public static void Add(System.Collections.Generic.Dictionary<object,object> Dictionary, System.Object item)
        {
            Dictionary.Add(item, item);
        }

        public static void AddIfNotContains(System.Collections.Generic.Dictionary<object,object> Dictionary, System.Object item)
        {
        ...
        public static void AddIfNotContains(System.Collections.Generic.List<object> Dictionary, System.Object item)
        {
        ...
        public static void AddAll(System.Collections.Generic.Dictionary<object,object> Dictionary, System.Collections.ICollection items)
        {
        ...
        public static void AddAllIfNotContains(System.Collections.Generic.Dictionary<object,object> Dictionary, System.Collections.IList items)
        {
            System.Object item;
        ...
        public static void AddAllIfNotContains(System.Collections.Generic.Dictionary<object,object> Dictionary, System.Collections.ICollection items)
        {
            System.Collections.IEnumerator iter = items.GetEnumerator();
            System.Object item;
            while (iter.MoveNext())
        ...
        public static void AddAllIfNotContains(System.Collections.Generic.IDictionary<string,string> Dictionary, System.Collections.Generic.ICollection<string> items)
        {
            foreach (string s in items)
            {
                if (Dictionary.ContainsKey(s) == false)
                {
                    Dictionary.Add(s, s);
                }
            }
        ...
        public static void AddAll(System.Collections.Generic.IDictionary<string, string> Dictionary, System.Collections.Generic.ICollection<string> items)
        {
            foreach (string s in items)
            {
                Dictionary.Add(s, s);
        ...
        public static System.String CollectionToString(System.Collections.ICollection c)
        {
            ...
            if (c != null)
            {
                ...
                System.Collections.Generic.List<object> l = new System.Collections.Generic.List<object>((IEnumerable<object>)c);

                bool isDictionary = (c is System.Collections.BitArray || c is System.Collections.Generic.Dictionary<object,object> || c is System.Collections.IDictionary || (l.Count > 0 && l[0] is System.Collections.DictionaryEntry));
                ...
                if (isDictionary)
                {
                    if (c is System.Collections.Generic.List<object>)
                        isDictionary = false;
                }
                if (isDictionary)
                {
        ...
        public static void Sort(System.Collections.IList list, System.Comparison<object> Comparator)
        {
            //if (((System.Collections.Generic.List<object>)list).IsReadOnly)
            //    throw new System.NotSupportedException();

            if ((Comparator == null) || (Comparator is System.Collections.IComparer))
            {
                try
                {
                    ((System.Collections.Generic.List<object>)list).Sort();
                }
            ...
            else
            {
                try
                {
                    ((System.Collections.Generic.List<object>)list).Sort((System.Comparison<object>)Comparator);
                }
                catch (System.InvalidOperationException e)
                {
                    throw new System.InvalidCastException(e.Message);
        ...
        public static void Fill(System.Array array, System.Int32 fromindex, System.Int32 toindex, System.Object val)
        {
            ...
            if (elementtype != val.GetType())
                Temp_Object = System.Convert.ChangeType(val, elementtype, System.Globalization.CultureInfo.CurrentCulture);
            if (array.Length == 0)
