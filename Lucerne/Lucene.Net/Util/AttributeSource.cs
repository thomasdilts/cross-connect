...
namespace Lucene.Net.Util
{
	...
	public class AttributeSource
	{
		...
		public abstract class AttributeFactory
		{
			...
			{
                private static readonly SupportClass.WeakDictionary attClassImplMap = new SupportClass.WeakDictionary();
		...
		private static readonly SupportClass.WeakDictionary knownImplClasses = new SupportClass.WeakDictionary();
		...
		public virtual void  AddAttributeImpl(AttributeImpl att)
		{
			...
			if (attributeImpls.Contains(clazz))
				return ;
			System.Collections.Generic.List<object> foundInterfaces;
			lock (knownImplClasses)
			{
				foundInterfaces = (System.Collections.Generic.List<object>) knownImplClasses[clazz];
				if (foundInterfaces == null)
				{
                    // we have a strong reference to the class instance holding all interfaces in the list (parameter "att"),
                    // so all WeakReferences are never evicted by GC
					knownImplClasses.Add(clazz, foundInterfaces = new System.Collections.Generic.List<object>());
