...
namespace Lucene.Net.Analysis
{
	...
	public class WordlistLoader
	{
		...
		/// </returns>
		public static System.Collections.Generic.Dictionary<object,object> GetWordSet(System.IO.FileInfo wordfile)
		{
			System.Collections.Generic.Dictionary<object,object> result = new System.Collections.Generic.Dictionary<object,object>();
			System.IO.StreamReader reader = null;
			try
			{
				reader = new System.IO.StreamReader(wordfile.FullName);
		...
		/// <returns> A HashSet with the file's words
		/// </returns>
		public static System.Collections.Generic.Dictionary<object,object> GetWordSet(System.IO.FileInfo wordfile, System.String comment)
		{
			System.Collections.Generic.Dictionary<object,object> result = new System.Collections.Generic.Dictionary<object,object>();
			System.IO.StreamReader reader = null;
			try
		...
		/// </returns>
		public static System.Collections.Generic.Dictionary<object,object> GetWordSet(System.IO.TextReader reader)
		{
			System.Collections.Generic.Dictionary<object,object> result = new System.Collections.Generic.Dictionary<object,object>();
		...
		/// <returns> A HashSet with the reader's words
		/// </returns>
        public static System.Collections.Generic.Dictionary<object,object> GetWordSet(System.IO.TextReader reader, System.String comment)
		{
			System.Collections.Generic.Dictionary<object,object> result = new System.Collections.Generic.Dictionary<object,object>();
		...
		public static System.Collections.Generic.Dictionary<object,object> GetStemDict(System.IO.FileInfo wordstemfile)
		{
			...
			try
			{
				fr = new System.IO.StreamReader(wordstemfile.FullName);
				br = new System.IO.StreamReader(fr.BaseStream, fr.CurrentEncoding);
				System.String line;
                char[] tab = {'\t'};
				while ((line = br.ReadLine()) != null)
				{
					System.String[] wordstem = line.Split(tab);
