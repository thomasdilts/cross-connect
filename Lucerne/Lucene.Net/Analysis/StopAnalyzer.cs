...
namespace Lucene.Net.Analysis
{
	...
	{
		private System.Collections.Generic.Dictionary<object,object> stopWords;
		// @deprecated
        [Obsolete]
		...
		/// for searching.
		/// </summary>
		public static System.Collections.Generic.Dictionary<object,object> ENGLISH_STOP_WORDS_SET;
		...
		public StopAnalyzer(System.Collections.Generic.Dictionary<object,object> stopWords)
		{
		...
		/// <summary>Builds an analyzer with the stop words from the given set.</summary>
		public StopAnalyzer(Version matchVersion, System.Collections.Generic.Dictionary<object,object> stopWords)
		{
			this.stopWords = stopWords;
			useDefaultStopPositionIncrement = false;
			enablePositionIncrements = StopFilter.GetEnablePositionIncrementsVersionDefault(matchVersion);
		...
		/// </deprecated>
        [Obsolete("Use StopAnalyzer(Version, Set) instead")]
		public StopAnalyzer(System.Collections.Generic.Dictionary<object,object> stopWords, bool enablePositionIncrements)
		{
			this.stopWords = stopWords;
			this.enablePositionIncrements = enablePositionIncrements;
			useDefaultStopPositionIncrement = false;
