...
namespace Lucene.Net.Analysis
{
	...
	{
		protected internal System.Collections.IList lst = new System.Collections.Generic.List<object>();
		...
		public SinkTokenizer(System.Collections.IList input)
		{
			this.lst = input;
			if (this.lst == null)
				this.lst = new System.Collections.Generic.List<object>();
		}
		...
		{
			this.lst = new System.Collections.Generic.List<object>(initCap);
		}
