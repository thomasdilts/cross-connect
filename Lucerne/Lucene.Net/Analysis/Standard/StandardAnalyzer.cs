...
namespace Lucene.Net.Analysis.Standard
{
	...
	{
		private System.Collections.Generic.Dictionary<object,object> stopSet;
		...
		/// useful for searching. 
		/// </summary>
		public static readonly System.Collections.Generic.Dictionary<object,object> STOP_WORDS_SET;
		...
		public StandardAnalyzer(System.Collections.Generic.Dictionary<object,object> stopWords):this(Version.LUCENE_24, stopWords)
		{
		}
		...
		/// </param>
		public StandardAnalyzer(Version matchVersion, System.Collections.Generic.Dictionary<object,object> stopWords)
		{
			stopSet = stopWords;
			Init(matchVersion);
		}
		...
		/// </deprecated>
        [Obsolete("Remove in 3.X and make true the only valid value")]
		public StandardAnalyzer(System.Collections.Generic.Dictionary<object,object> stopwords, bool replaceInvalidAcronym):this(Version.LUCENE_24, stopwords)
		{
			this.replaceInvalidAcronym = replaceInvalidAcronym;
		}
