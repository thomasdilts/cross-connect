...
namespace Lucene.Net.Index
{
	...
	public sealed class DocumentsWriter
	{
		...
		private System.Collections.Generic.Dictionary<object,object> threadBindings = new System.Collections.Generic.Dictionary<object,object>();
		...
		* including any flushed segments. */
		...
		private bool ApplyDeletes(IndexReader reader, int docIDStart)
		{
			lock (this)
			{
				...
				// Delete by term
                //System.Collections.IEnumerator iter = new System.Collections.Generic.Dictionary<object,object>();
                ...
                iter = new System.Collections.Generic.Dictionary<object, object>(deletesFlushed.queries).GetEnumerator();
				while (iter.MoveNext())
				{
					System.Collections.DictionaryEntry entry = (System.Collections.DictionaryEntry) iter.Current;
		...
		internal class ByteBlockAllocator:ByteBlockPool.Allocator
		{
            ...
            int blockSize;
			internal System.Collections.Generic.List<object> freeByteBlocks = new System.Collections.Generic.List<object>();
            ...
            public /*internal*/ override void RecycleByteBlocks(System.Collections.Generic.List<object> blocks)
            {
                lock (Enclosing_Instance)
                {
		...
		private System.Collections.Generic.List<object> freeIntBlocks = new System.Collections.Generic.List<object>();
		...
		private System.Collections.Generic.List<object> freeCharBlocks = new System.Collections.Generic.List<object>();
