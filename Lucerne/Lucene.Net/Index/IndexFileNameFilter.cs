...
namespace Lucene.Net.Index
{
	...
	public class IndexFileNameFilter
	{
        ...
        private System.Collections.Generic.Dictionary<object,object> extensions;
        private System.Collections.Generic.Dictionary<object,object> extensionsInCFS;
		
		// Prevent instantiation.
		private IndexFileNameFilter()
		{
            extensions = new System.Collections.Generic.Dictionary<object,object>();
			for (int i = 0; i < IndexFileNames.INDEX_EXTENSIONS.Length; i++)
			{
				extensions.Add(IndexFileNames.INDEX_EXTENSIONS[i], IndexFileNames.INDEX_EXTENSIONS[i]);
			}
            extensionsInCFS = new System.Collections.Generic.Dictionary<object,object>();
		...
		*/
		...
		public virtual bool IsCFSFile(System.String name)
		{
			...
			{
				System.String extension = name.Substring(1 + i);
				if (extensionsInCFS.ContainsKey(extension))
				{
					return true;
				}
