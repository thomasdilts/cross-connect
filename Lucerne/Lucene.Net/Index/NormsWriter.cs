...
namespace Lucene.Net.Index
{
	...
	sealed class NormsWriter:InvertedDocEndConsumer
	{
        ...
        public override void Flush(System.Collections.Generic.Dictionary<object, object> threadsAndFields, SegmentWriteState state)
		{
			...
			System.Collections.IDictionary byField = new System.Collections.Generic.Dictionary<object,object>();
			...
			foreach(var entry in it)
			{
                ...
                System.Collections.Generic.List<object> fieldsToRemove = new System.Collections.Generic.List<object>();
				...
				while (fieldsIt.MoveNext())
				{
					...
					if (perField.upto > 0)
					{
						...
						if (l == null)
						{
							l = new System.Collections.Generic.List<object>();
                ...
                System.Collections.Generic.Dictionary<object, object> fieldsHT = (System.Collections.Generic.Dictionary<object, object>)fields;
