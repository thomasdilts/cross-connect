...
namespace Lucene.Net.Index
{
	...
	public class PositionBasedTermVectorMapper:TermVectorMapper
	{
		...
		public override void  SetExpectations(System.String field, int numTerms, bool storeOffsets, bool storePositions)
		{
			...
			fieldToTerms = new System.Collections.Generic.Dictionary<object,object>();
			this.storeOffsets = storeOffsets;
			currentField = field;
			currentPositions = new System.Collections.Generic.Dictionary<object,object>();
		...
		public class TVPositionInfo
		{
			...
			public TVPositionInfo(int position, bool storeOffsets)
			{
				...
				terms = new System.Collections.Generic.List<object>();
				if (storeOffsets)
				{
					offsets = new System.Collections.Generic.List<object>();
				}
			}
