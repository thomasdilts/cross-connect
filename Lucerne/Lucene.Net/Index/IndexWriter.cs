...
namespace Lucene.Net.Index
{
	...
	*/
	public class IndexWriter : System.IDisposable
	{
		...
		private System.Collections.Generic.Dictionary<object,object> rollbackSegments;
        ...
        private System.Collections.Generic.Dictionary<object,object> segmentsToOptimize = new System.Collections.Generic.Dictionary<object,object>(); // used by optimize to note those needing optimization
		...
		// merges
        private System.Collections.Generic.Dictionary<object,object> mergingSegments = new System.Collections.Generic.Dictionary<object,object>();
		...
		private System.Collections.IList mergeExceptions = new System.Collections.Generic.List<object>();
		...
		internal class ReaderPool
		{
            ...
            private System.Collections.Generic.Dictionary<object, object> readerMap = new System.Collections.Generic.Dictionary<object, object>();
			...
			internal virtual void  Clear(SegmentInfos infos)
			{
				lock (this)
				{
					if (infos == null)
					{
                        System.Collections.Generic.Dictionary<object, object> iter = new System.Collections.Generic.Dictionary<object, object>(readerMap);
			...
			internal virtual void  Close()
			{
				lock (this)
				{
                    System.Collections.IEnumerator iter = new System.Collections.Generic.Dictionary<object, object>(readerMap).GetEnumerator();
					while (iter.MoveNext())
					{
		...
		private void  SetRollbackSegmentInfos(SegmentInfos infos)
		{
			lock (this)
			{
				rollbackSegmentInfos = (SegmentInfos) infos.MemberwiseClone();
				System.Diagnostics.Debug.Assert(!rollbackSegmentInfos.HasExternalSegments(directory));
				rollbackSegments = new System.Collections.Generic.Dictionary<object,object>();
        ...
        *  IndexReader#DEFAULT_TERMS_INDEX_DIVISOR}. */
		...
		public virtual void  Optimize(int maxNumSegments, bool doWait)
		{
			...
			lock (this)
			{
				...
				segmentsToOptimize = new System.Collections.Generic.Dictionary<object,object>();
		...
		*/
		private void  StartTransaction(bool haveReadLock)
		{
			lock (this)
			{
				...
				try
				{
					localRollbackSegmentInfos = (SegmentInfos) segmentInfos.MemberwiseClone();
		...
		*/
		...
		private void  ResetMergeExceptions()
		{
			lock (this)
			{
				mergeExceptions = new System.Collections.Generic.List<object>();
				mergeGen++;
			}
		}
		...
		* addIndexesNoOptimize(). */
		...
		private bool CommitMerge(MergePolicy.OneMerge merge, SegmentMerger merger, int mergedDocCount, SegmentReader mergedReader)
		{
			lock (this)
			{
				...
				((System.Collections.IList) ((System.Collections.Generic.List<object>) segmentInfos).GetRange(start, start + merge.segments.Count - start)).Clear();
        ...
        private void SetDiagnostics(SegmentInfo info, System.String source, System.Collections.Generic.IDictionary<string, string> details)
		{
			...
			if (details != null)
			{
				//System.Collections.Generic.List<object> keys = new System.Collections.Generic.List<object>(details.Keys);
				//System.Collections.Generic.List<object> values = new System.Collections.Generic.List<object>(details.Values);
		...
		private int MergeMiddle(MergePolicy.OneMerge merge)
		{
            ...
            System.Collections.Generic.Dictionary<object,object> dss = new System.Collections.Generic.Dictionary<object,object>();
        ...
        private System.Collections.Generic.Dictionary<string, string> syncing = new System.Collections.Generic.Dictionary<string, string>();
			...
			try
			{
				...
				lock (this)
				{
					...
					try
					{
                        ...
                        toSync = (SegmentInfos) segmentInfos.MemberwiseClone();
