...
namespace Lucene.Net.Index
{
	...
	{
        private System.Collections.IDictionary fieldToTerms = new System.Collections.Generic.Dictionary<object, object>();
		private System.Collections.Generic.Dictionary<object, object> currentSet;
		...
		public override void  Map(System.String term, int frequency, TermVectorOffsetInfo[] offsets, int[] positions)
		{
            ...
            //Thomas dilts..  currentSet = (from t in currentSet orderby t.Key ascending select t).ToDictionary(x => x.Key, x => x.Value); 
            //comparator.Compare()
		}
		
		public override void  SetExpectations(System.String field, int numTerms, bool storeOffsets, bool storePositions)
		{
			currentSet = new System.Collections.Generic.Dictionary<object, object>();
			currentField = field;
