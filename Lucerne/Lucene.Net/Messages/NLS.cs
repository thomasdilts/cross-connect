...
namespace Lucene.Net.Messages
{
	...
	public class NLS
	{
		...
		private static System.Collections.IDictionary bundles = new System.Collections.Generic.Dictionary<object,object>();
		...
		private static System.Object GetResourceBundleObject(System.String messageKey, System.Globalization.CultureInfo locale)
		{
			...
			for (System.Collections.IEnumerator it = bundles.Keys.GetEnumerator(); it.MoveNext(); )
			{
                ...
                System.Resources.ResourceManager resourceBundle = new System.Resources.ResourceManager(clazz);//.ResourceManager.CreateFileBasedResourceManager(clazz.Name, "Messages", null); //{{Lucene.Net-2.9.1}} Can we make resourceDir "Messages" more general
		...
		private static void  Load(System.Type clazz)
		{
			...
			System.Collections.IDictionary fields = new System.Collections.Generic.Dictionary<object,object>();
			for (int i = 0; i < len; i++)
			{
		...
		private static void  ValidateMessage(System.String key, System.Type clazz)
		{
			...
			try
			{
                ...
                System.Resources.ResourceManager resourceBundle = new System.Resources.ResourceManager(clazz);// System.Resources.ResourceManager.CreateFileBasedResourceManager(clazz.FullName, "", null);
				if (resourceBundle != null)
				{
