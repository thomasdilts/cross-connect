	...
	public class QueryParser : QueryParserConstants
	{
		...
		public virtual void  SetDateResolution(System.String fieldName, DateTools.Resolution dateResolution)
		{
			...
			if (fieldToDateResolution == null)
			{
				...
				fieldToDateResolution = new System.Collections.Generic.Dictionary<object,object>();
			}
		...
		protected internal virtual void  AddClause(System.Collections.Generic.List<object> clauses, int conj, int mods, Query q)
		{
			...
			else
			{
				if (severalTokensAtSamePosition)
				{
					...
					else
					{
						...
						System.Collections.Generic.List<object> multiTerms = new System.Collections.Generic.List<object>();
						int position = - 1;
						for (int i = 0; i < numTokens; i++)
						{
							System.String term = null;
							...
							if (positionIncrement > 0 && multiTerms.Count > 0)
							{
								...
								{
                                    mpq.Add((Term[]) multiTerms.ToArray(), position);
								}
								else
								{
		...
		protected internal virtual Query GetBooleanQuery(System.Collections.Generic.List<object> clauses)
		{
		...
		protected internal virtual Query GetBooleanQuery(System.Collections.Generic.List<object> clauses, bool disableCoord)
		{
...
label_1_brk: ;  // {{Aroush-2.9}} this lable maybe misplaced
		...
		private System.Collections.IList jj_expentries = new System.Collections.Generic.List<object>();
