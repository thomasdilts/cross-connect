...
namespace Lucene.Net.Search
{
	...
	class FieldCacheImpl : ExtendedFieldCache_old.ExtendedFieldCache
	{
		...
		private void  Init()
		{
			lock (this)
			{
                System.Collections.Generic.Dictionary<object,object> caches2 = new System.Collections.Generic.Dictionary<object,object>();
		...
		{
            System.Collections.Generic.List<object> result = new System.Collections.Generic.List<object>(17);
			...
			while (outerKeys.MoveNext())
			{
				...
				while (innerKeys.MoveNext())
				{
					...
					if (null != readerKey && cache.readerCache.ContainsKey(readerKey))
					{
                        ...
                        System.Collections.Generic.Dictionary<object, object> entrySetIterator = new System.Collections.Generic.Dictionary<object, object>();
                        foreach (var mapEntry in entrySetIterator)
						{
			...
			return (CacheEntry[]) new System.Collections.Generic.List<object>(result).ToArray();
		}
		...
		internal abstract class Cache
		{
            ...
            internal System.Collections.Generic.Dictionary<object,object> readerCache = new SupportClass.WeakDictionary();
			...
			public virtual System.Object Get(IndexReader reader, Entry key)
			{
				...
				lock (readerCache)
				{
					...
					if (innerCache == null)
					{
						innerCache = new System.Collections.Generic.Dictionary<object,object>();
