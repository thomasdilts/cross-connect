	...
	* BooleanScorer & BooleanScorer2 */
	...
	class BooleanScorer2:Scorer
	{
		...
		private class AnonymousClassConjunctionScorer:ConjunctionScorer
		{
			...
			internal AnonymousClassConjunctionScorer(int requiredNrMatchers, BooleanScorer2 enclosingInstance, Lucene.Net.Search.Similarity Param1, System.Collections.Generic.List<object> Param2):base(Param1, Param2)
			{
        ...
        private System.Collections.Generic.List<object> requiredScorers;
		private System.Collections.Generic.List<object> optionalScorers;
        private System.Collections.Generic.List<object> prohibitedScorers;
		...
		/// </param>
        public BooleanScorer2(Similarity similarity, int minNrShouldMatch, System.Collections.Generic.List<object> required, System.Collections.Generic.List<object> prohibited, System.Collections.Generic.List<object> optional)
            : base(similarity)
		{
		...
		private Scorer CountingConjunctionSumScorer(System.Collections.Generic.List<object> requiredScorers)
		{
			// each scorer from the list counted as a single matcher
		...
		private Scorer MakeCountingSumScorerSomeReq()
		{
			...
			if (optionalScorers.Count == minNrShouldMatch)
			{
				...
				System.Collections.Generic.List<object> allReq = new System.Collections.Generic.List<object>(requiredScorers);
