	...
	public class QueryTermVector : TermFreqVector
	{
			...
			if (analyzer != null)
			{
				...
				if (stream != null)
				{
					...
					try
					{
						...
						ProcessTerms((System.String[]) terms.ToArray());
					}
		...
		private void  ProcessTerms(System.String[] queryTerms)
		{
			if (queryTerms != null)
			{
				...
				System.Collections.IDictionary tmpSet = new System.Collections.Generic.Dictionary<object,object>();
				//filter out duplicates
				System.Collections.Generic.List<object> tmpList = new System.Collections.Generic.List<object>(queryTerms.Length);
				System.Collections.Generic.List<object> tmpFreqs = new System.Collections.Generic.List<object>(queryTerms.Length);
				int j = 0;
                ...
                terms = (System.String[]) tmpList.ToArray();
