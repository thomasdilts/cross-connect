...
namespace Lucene.Net.Search
{
	...
	public class BooleanQuery:Query, System.ICloneable
	{
		...
		protected internal class BooleanWeight:Weight
		{
            ...
            [System.Runtime.Serialization.DataMember]
            protected internal System.Collections.Generic.List<object> weights;
			
			public BooleanWeight(BooleanQuery enclosingInstance, Searcher searcher)
			{
				InitBlock(enclosingInstance);
				this.similarity = Enclosing_Instance.GetSimilarity(searcher);
				weights = new System.Collections.Generic.List<object>(Enclosing_Instance.clauses.Count);
			...
			{
                System.Collections.Generic.List<object> required = new System.Collections.Generic.List<object>();
                System.Collections.Generic.List<object> prohibited = new System.Collections.Generic.List<object>();
                System.Collections.Generic.List<object> optional = new System.Collections.Generic.List<object>();
				for (System.Collections.IEnumerator wIter = weights.GetEnumerator(), cIter = Enclosing_Instance.clauses.GetEnumerator(); wIter.MoveNext(); )
				{
                    cIter.MoveNext();
		...
		// inherit javadoc
		public override void  ExtractTerms(System.Collections.Generic.Dictionary<object,object> terms)
		{
