	...
	public abstract class MultiTermQuery:Query
	{
		...
		public class ConstantScoreAutoRewrite:RewriteMethod
		{
			...
			public override Query Rewrite(IndexReader reader, MultiTermQuery query)
			{
				...
				System.Collections.Generic.List<object> pendingTerms = new System.Collections.Generic.List<object>();
			...
			{
				int prime = 1279;
				return (int) (prime * termCountCutoff + Convert.ToInt64(docCountPercent));
			}
			...
			public  override bool Equals(System.Object obj)
			{
				...
				if (Convert.ToInt64(other.docCountPercent) != Convert.ToInt64(docCountPercent))
				{
					return false;
				}
