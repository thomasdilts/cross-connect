...
namespace Lucene.Net.Analysis.AR
{
    ...
    public class ArabicAnalyzer : Analyzer
    {
        ...
        public ArabicAnalyzer(Version matchVersion)
        {
            ...
            using (StreamReader reader = new StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Lucene.Net.Analyzers.AR." + DEFAULT_STOPWORD_FILE)))
            {
         ...
         * Builds an analyzer with the given stop words.
         *
         * @deprecated Use {@link #ArabicAnalyzer(Version, Dictionary)} instead
         */
        public ArabicAnalyzer(Dictionary<object,object> stopwords) : this(Version.LUCENE_24, stopwords)
        {
        }
         ...
         * Builds an analyzer with the given stop words.
         */
        public ArabicAnalyzer(Version matchVersion, Dictionary<object, object> stopwords)
        {
            stoptable = new Dictionary<object,object>(stopwords);
            this.matchVersion = matchVersion;
        }
