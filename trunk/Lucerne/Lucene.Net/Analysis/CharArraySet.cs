...
namespace Lucene.Net.Analysis
{
    ...
    public class CharArraySet : System.Collections.Generic.Dictionary<object, object>
	{
		...
		public bool ContainsKey(System.Object o)
		{
			if (o is char[])
			{
				char[] text = (char[]) o;
		...
		public virtual bool Add(System.Object o)
		{
            ...
            if (o is System.Collections.Generic.Dictionary<object,object>)
            {
                foreach (string word in ((System.Collections.Generic.Dictionary<object, object>)o).Keys)
                {
                    Add(word);
                }
                return true;
		...
		public class CharArraySetIterator : System.Collections.IEnumerator
		{
			...
			{
                System.Diagnostics.Debug.WriteLine("Port issue:", "Need to implement this call, CharArraySetIterator.Reset()");  // {{Aroush-2.9
			}
		}
