...
namespace Lucene.Net.Analysis
{
	...
	public sealed class StopFilter:TokenFilter
	{
		...
		/// </deprecated>
        [Obsolete("Use StopFilter(bool, TokenStream, Dictionary) instead.")]
		...
		/// </deprecated>
        [Obsolete("Use StopFilter(bool, TokenStream, Dictionary, bool) instead.")]
		...
		public StopFilter(TokenStream input, System.Collections.Generic.Dictionary<object,object> stopWords, bool ignoreCase):this(ENABLE_POSITION_INCREMENTS_DEFAULT, input, stopWords, ignoreCase)
		{
		}
		...
		/// <param name="ignoreCase">-Ignore case when stopping.
		/// </param>
		public StopFilter(bool enablePositionIncrements, TokenStream input, System.Collections.Generic.Dictionary<object,object> stopWords, bool ignoreCase):base(input)
		{
		...
		/// </deprecated>
        [Obsolete("Use StopFilter(bool, TokenStream, Dictionary) instead")]
		public StopFilter(TokenStream in_Renamed, System.Collections.Generic.Dictionary<object,object> stopWords):this(ENABLE_POSITION_INCREMENTS_DEFAULT, in_Renamed, stopWords, false)
		{
		}
		...
		/// <seealso cref="MakeStopSet(java.lang.String[])">
		/// </seealso>
		public StopFilter(bool enablePositionIncrements, TokenStream in_Renamed, System.Collections.Generic.Dictionary<object,object> stopWords):this(enablePositionIncrements, in_Renamed, stopWords, false)
		{
		}
		...
		/// </seealso>
		public static System.Collections.Generic.Dictionary<object,object> MakeStopSet(System.String[] stopWords)
		{
		...
		/// <seealso cref="MakeStopSet(java.lang.String[], boolean)"> passing false to ignoreCase
		/// </seealso>
		public static System.Collections.Generic.Dictionary<object,object> MakeStopSet(System.Collections.IList stopWords)
		{
			return MakeStopSet(stopWords, false);
		}
		...
		/// </returns>
		public static System.Collections.Generic.Dictionary<object,object> MakeStopSet(System.String[] stopWords, bool ignoreCase)
		{
			CharArraySet stopSet = new CharArraySet(stopWords.Length, ignoreCase);
			stopSet.AddAll(new System.Collections.Generic.List<object>(stopWords));
			return stopSet;
		}
		...
		/// <returns> A Set containing the words
		/// </returns>
		public static System.Collections.Generic.Dictionary<object,object> MakeStopSet(System.Collections.IList stopWords, bool ignoreCase)
		{
