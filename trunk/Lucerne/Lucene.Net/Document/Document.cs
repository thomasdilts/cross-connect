...
namespace Lucene.Net.Documents
{
	...
	public sealed class Document
	{
        ...
        [System.Runtime.Serialization.DataMember]
		internal System.Collections.IList fields = new System.Collections.Generic.List<object>();
        [System.Runtime.Serialization.DataMember]
		...
		public Fieldable[] GetFieldables(System.String name)
		{
			...
			return (Fieldable[]) result.ToArray();
		}
		...
		public System.String[] GetValues(System.String name)
		{
			...
			return (System.String[]) result.ToArray();
		}
		...
		{
			System.Collections.IList result = new System.Collections.Generic.List<object>();
			for (int i = 0; i < fields.Count; i++)
			{
				Fieldable field = (Fieldable) fields[i];
				if (field.Name().Equals(name) && (field.IsBinary()))
