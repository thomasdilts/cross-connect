...
namespace Lucene.Net.Documents
{
	...
	public class SetBasedFieldSelector : FieldSelector
	{
		...
		private System.Collections.Generic.Dictionary<object,object> fieldsToLoad;
        [System.Runtime.Serialization.DataMember]
		private System.Collections.Generic.Dictionary<object,object> lazyFieldsToLoad;
		...
		/// </param>
		public SetBasedFieldSelector(System.Collections.Generic.Dictionary<object,object> fieldsToLoad, System.Collections.Generic.Dictionary<object,object> lazyFieldsToLoad)
		{
		...
		public virtual FieldSelectorResult Accept(System.String fieldName)
		{
			...
			if (fieldsToLoad.ContainsKey(fieldName) == true)
			{
				result = FieldSelectorResult.LOAD;
			}
			if (lazyFieldsToLoad.ContainsKey(fieldName) == true)
			{
