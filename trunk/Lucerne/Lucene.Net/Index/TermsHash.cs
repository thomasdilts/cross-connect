...
namespace Lucene.Net.Index
{
	...
	sealed class TermsHash:InvertedDocConsumer
	{
        ...
        internal override void Flush(System.Collections.Generic.Dictionary<object, object> threadsAndFields, SegmentWriteState state)
		{
			lock (this)
			{
                ...
                System.Collections.Generic.Dictionary<object, object> nextThreadsAndFields;
				
				if (nextTermsHash != null)
				{
					nextThreadsAndFields = new System.Collections.Generic.Dictionary<object,object>();
				}
				else
				...
				foreach(var entry in it)
				{
					...
					System.Collections.Generic.Dictionary<object,object> nextChildFields;
					
					if (nextTermsHash != null)
					{
                        nextChildFields = new System.Collections.Generic.Dictionary<object,object>();
					}
					else
