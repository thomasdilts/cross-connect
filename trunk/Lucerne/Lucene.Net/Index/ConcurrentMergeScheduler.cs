...
namespace Lucene.Net.Index
{
	...
	public class ConcurrentMergeScheduler:MergeScheduler
	{
		...
		protected internal System.Collections.IList mergeThreads = new System.Collections.Generic.List<object>();
		...
		private void  AddMyself()
		{
			lock (allInstances.SyncRoot)
			{
				...
				((System.Collections.IList) ((System.Collections.Generic.List<object>) allInstances).GetRange(upto, allInstances.Count - upto)).Clear();
		...
		{
			allInstances = new System.Collections.Generic.List<object>();
		}
	}
}