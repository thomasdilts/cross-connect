...
namespace Lucene.Net.Index
{
	...
	public class DirectoryReader:IndexReader, System.ICloneable
	{
        ...
        private System.Collections.Generic.Dictionary<object, object> normsCache = new System.Collections.Generic.Dictionary<object, object>();
		...
		internal DirectoryReader(IndexWriter writer, SegmentInfos infos, int termInfosIndexDivisor)
		{
			...
			this.readOnly = true;
			segmentInfos = infos;
			segmentInfosStart = (SegmentInfos) infos.MemberwiseClone();
			this.termInfosIndexDivisor = termInfosIndexDivisor;
			if (!readOnly)
			{
				// We assume that this segments_N was previously
        ...
        internal DirectoryReader(Directory directory, SegmentInfos infos, SegmentReader[] oldReaders, int[] oldStarts, System.Collections.Generic.Dictionary<object, object> oldNormsCache, bool readOnly, bool doClone, int termInfosIndexDivisor)
		{
			this.directory = directory;
			this.readOnly = readOnly;
			...
			System.Collections.IDictionary segmentReaders = new System.Collections.Generic.Dictionary<object,object>();
			...
			{
                System.Collections.Generic.Dictionary<object, object> it = new System.Collections.Generic.Dictionary<object, object>(oldNormsCache);
		...
		public override IndexReader Clone(bool openReadOnly)
		{
			lock (this)
			{
				DirectoryReader newReader = DoReopen((SegmentInfos) segmentInfos.MemberwiseClone(), true, openReadOnly);
		...
		public static new System.Collections.ICollection ListCommits(Directory dir)
		{
			...
			System.Collections.Generic.List<object> commits = new System.Collections.Generic.List<object>();
