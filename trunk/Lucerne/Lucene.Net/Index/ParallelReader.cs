...
namespace Lucene.Net.Index
{
	...
	{
		private System.Collections.Generic.List<object> readers = new System.Collections.Generic.List<object>();
		private System.Collections.IList decrefOnClose = new System.Collections.Generic.List<object>(); // remember which subreaders to decRef on close
		internal bool incRefReaders = false;
        private System.Collections.Generic.Dictionary<object, object> fieldToReader = new System.Collections.Generic.Dictionary<object, object>();
        private System.Collections.IDictionary readerToFields = new System.Collections.Generic.Dictionary<object, object>();
		private System.Collections.IList storedFieldReaders = new System.Collections.Generic.List<object>();
		...
		protected internal virtual IndexReader DoReopen(bool doClone)
		{
			...
			bool reopened = false;
			System.Collections.IList newReaders = new System.Collections.Generic.List<object>();
			...
			if (reopened)
			{
				System.Collections.IList newDecrefOnClose = new System.Collections.Generic.List<object>();
		...
		public override TermFreqVector[] GetTermFreqVectors(int n)
		{
            ...
            System.Collections.IEnumerator i = new System.Collections.Generic.Dictionary<object,object>(fieldToReader).GetEnumerator();
			while (i.MoveNext())
			{
			...
			return (TermFreqVector[]) results.ToArray();
		}
		...
		public override void  GetTermFreqVector(int docNumber, TermVectorMapper mapper)
		{
            ...
            System.Collections.Generic.Dictionary<object, object> i = new System.Collections.Generic.Dictionary<object, object>(fieldToReader);
			foreach(var e in i)
			{
				System.String field = (System.String) e.Key;
				IndexReader reader = (IndexReader) e.Value;
		...
		{
			return (IndexReader[]) readers.ToArray();
		}
		...
		private class ParallelTermEnum:TermEnum
		{
			...
			public ParallelTermEnum(ParallelReader enclosingInstance)
			{
				...
				try
				{
                    field = ((System.String)Enclosing_Instance.fieldToReader.Keys.First());//.GetKey(0));
				}
			...
			public override bool Next()
			{
				...
				if (fieldIterator == null)
				{
                    ...
                    System.Collections.Generic.Dictionary<object, object> newList = new System.Collections.Generic.Dictionary<object, object>();
                    if (Enclosing_Instance.fieldToReader != null)
                    {
                        if (Enclosing_Instance.fieldToReader.Count > 0)
                        {
                            int index = 0;
                            while (comparer.Compare(Enclosing_Instance.fieldToReader.ElementAt(index), field) < 0)
                                index++;
                            for (; index < Enclosing_Instance.fieldToReader.Count; index++)
                            {
                                newList.Add(Enclosing_Instance.fieldToReader.ElementAt(index), Enclosing_Instance.fieldToReader[Enclosing_Instance.fieldToReader.ElementAt(index)]);
                            }
                        }
                    }
