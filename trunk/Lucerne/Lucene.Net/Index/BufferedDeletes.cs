...
namespace Lucene.Net.Index
{
	...
	class BufferedDeletes
	{
        ...
        internal System.Collections.Generic.Dictionary<object, object> terms = null;
		internal System.Collections.Generic.Dictionary<object,object> queries = new System.Collections.Generic.Dictionary<object,object>();
		internal System.Collections.Generic.List<object> docIDs = new System.Collections.Generic.List<object>();
        ...
        public BufferedDeletes(bool doTermSort)
        {
            ...
            if (doTermSort)
            {
                terms = new System.Collections.Generic.Dictionary<object, object>();
            }
            else
            {
                terms = new System.Collections.Generic.Dictionary<object,object>();
		...
		internal virtual void  Update(BufferedDeletes in_Renamed)
		{
            ...
            System.Collections.Generic.List<object> keys = new System.Collections.Generic.List<object>(in_Renamed.terms.Keys);
            System.Collections.Generic.List<object> values = new System.Collections.Generic.List<object>(in_Renamed.terms.Values);
			for (int i=0; i < keys.Count; i++)
				terms[keys[i]] = values[i];

			keys = new System.Collections.Generic.List<object>(in_Renamed.queries.Keys);
			values = new System.Collections.Generic.List<object>(in_Renamed.queries.Values);
			for (int i=0; i < keys.Count; i++)
		...
		internal virtual void  Remap(MergeDocIDRemapper mapper, SegmentInfos infos, int[][] docMaps, int[] delCounts, MergePolicy.OneMerge merge, int mergeDocCount)
		{
			lock (this)
			{
                ...
                System.Collections.Generic.Dictionary<object, object> newDeleteTerms;
				...
				if (terms.Count > 0)
				{
                    if (doTermSort)
                    {
                        newDeleteTerms = new System.Collections.Generic.Dictionary<object, object>();
                    }
                    else
                    {
                        newDeleteTerms = new System.Collections.Generic.Dictionary<object,object>();
                    }
                    System.Collections.Generic.Dictionary<object, object> iter = new System.Collections.Generic.Dictionary<object, object>(terms);
				...
				System.Collections.Generic.List<object> newDeleteDocIDs;
				
				if (docIDs.Count > 0)
				{
					newDeleteDocIDs = new System.Collections.Generic.List<object>(docIDs.Count);
				...
				System.Collections.Generic.Dictionary<object,object> newDeleteQueries;
				
				if (queries.Count > 0)
				{
					newDeleteQueries = new System.Collections.Generic.Dictionary<object,object>();
					System.Collections.Generic.Dictionary<object,object> iter = new System.Collections.Generic.Dictionary<object,object>(queries);
					foreach(var entry in iter)
					{
