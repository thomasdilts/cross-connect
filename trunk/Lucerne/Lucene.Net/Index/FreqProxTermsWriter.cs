...
namespace Lucene.Net.Index
{
	...
	sealed class FreqProxTermsWriter:TermsHashConsumer
	{
        ...
        public override void Flush(System.Collections.Generic.Dictionary<object, object> threadsAndFields, SegmentWriteState state)
		{
			...
			// ThreadStates
			System.Collections.Generic.List<object> allFields = new System.Collections.Generic.List<object>();
			...
			*/
            ...
            it = new System.Collections.Generic.Dictionary<object, object>(threadsAndFields);
			foreach(var entry in it)
			{
