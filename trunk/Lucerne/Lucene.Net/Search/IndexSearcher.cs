...
namespace Lucene.Net.Search
{
	...
	public class IndexSearcher:Searcher
	{
		...
		private IndexSearcher(IndexReader r, bool closeReader)
		{
            ...
            System.Collections.Generic.List<object> subReadersList = new System.Collections.Generic.List<object>();
			GatherSubReaders(subReadersList, reader);
            subReaders = (IndexReader[])new System.Collections.Generic.List<object>(subReadersList).ToArray();
