...
namespace Lucene.Net.Search.Spans
{
	...
	public class SpanWeight:Weight
	{
        ...
        [System.Runtime.Serialization.DataMember]
        protected internal System.Collections.Generic.Dictionary<object, object> terms;
        [System.Runtime.Serialization.DataMember]
		...
		public SpanWeight(SpanQuery query, Searcher searcher)
		{
			...
			idfExp = similarity.idfExplain(new System.Collections.Generic.List<object>(terms.Values), searcher);
			idf = idfExp.GetIdf();
		}
