...
namespace Lucene.Net.Search.Spans
{
	...
	public class SpanNearQuery:SpanQuery, System.ICloneable
	{
        ...
        protected internal System.Collections.Generic.List<object> clauses;
        [System.Runtime.Serialization.DataMember]
		...
		public SpanNearQuery(SpanQuery[] clauses, int slop, bool inOrder, bool collectPayloads)
		{
			...
			this.clauses = new System.Collections.Generic.List<object>(clauses.Length);
		...
		public override System.Collections.Generic.List<object> GetTerms()
		{
			...
			while (i.MoveNext())
			{
				...
				terms.AddRange((System.Collections.Generic.List<object>)clause.GetTerms());
			}
			return terms;
		}
