...
namespace Lucene.Net.Search
{
	...
	class ConjunctionScorer:Scorer
	{
        ...
        public ConjunctionScorer(Similarity similarity, System.Collections.Generic.List<object> scorers)
            : this(similarity, (Scorer[])new System.Collections.Generic.List<object>(scorers).ToArray())
		{
		}
