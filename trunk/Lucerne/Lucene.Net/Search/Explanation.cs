...
namespace Lucene.Net.Search
{
	...
	public class Explanation
	{
        ...
        [System.Runtime.Serialization.DataMember]
        private System.Collections.Generic.List<object> details; // sub-explanations
		...
		public virtual Explanation[] GetDetails()
		{
			if (details == null)
				return null;
			return (Explanation[]) details.ToArray();
		}
		...
		{
			if (details == null)
				details = new System.Collections.Generic.List<object>();
			details.Add(detail);
		}
