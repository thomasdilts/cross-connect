	...
	sealed class SloppyPhraseScorer:PhraseScorer
	{
		...
		private int InitPhrasePositions()
		{
			...
			if (!checkedRepeats)
			{
				checkedRepeats = true;
				// check for repeats
				System.Collections.Generic.Dictionary<object,object> m = null;
				for (PhrasePositions pp = first; pp != null; pp = pp.next)
				{
					...
					for (PhrasePositions pp2 = pp.next; pp2 != null; pp2 = pp2.next)
					{
						...
						if (tpPos2 == tpPos)
						{
							if (m == null)
							{
								m = new System.Collections.Generic.Dictionary<object,object>();
							}
							pp.repeats = true;
							pp2.repeats = true;
							m[pp] = null;
				...
				if (m != null)
				{
					repeats = (PhrasePositions[])(new System.Collections.Generic.List<object>(m.Keys).ToArray());
				}
			}
