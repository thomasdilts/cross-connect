...
namespace Lucene.Net.Store
{
	...
	public class FileSwitchDirectory:Directory
	{
		...
		private System.Collections.Generic.Dictionary<object,object> primaryExtensions;
		private bool doClose;
		
		public FileSwitchDirectory(System.Collections.Generic.Dictionary<object,object> primaryExtensions, Directory primaryDir, Directory secondaryDir, bool doClose)
		{
		...
		private Directory GetDirectory(System.String name)
		{
			...
			if (primaryExtensions.ContainsKey(ext))
			{
				return primaryDir;
			}
			else
