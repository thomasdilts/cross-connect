	...
	public class MMapDirectory:FSDirectory
	{
		private class AnonymousClassPrivilegedExceptionAction // : SupportClass.IPriviligedAction   // {{Aroush-2.9}}
		{
			...
			public virtual System.Object Run()
			{
                ...
                */
                System.Diagnostics.Debug.WriteLine("Port issue:", "sun.misc.Cleaner()"); // {{Aroush-2.9}}
                // Aroush-2.9}}
				return null;
			}
		}
		...
		internal void  CleanMapping(System.IO.MemoryStream buffer)
		{
			if (useUnmapHack)
			{
				try
				{
                    ...
                    System.Diagnostics.Debug.WriteLine("Port issue:", "java.security.AccessController.doPrivileged()"); // {{Aroush-2.9}}
		...
		{
			{
				...
				try
				{
                    ...
                    */
                    System.Diagnostics.Debug.WriteLine("Port issue:", "sun.misc.Cleaner.clean()"); // {{Aroush-2.9}}
                    // Aroush-2.9}}
					v = true;
				}
				catch (System.Exception e)
