...
//                System.Diagnostics.Debug.WriteLine("Port issue:", "byteBuf = ByteBuffer.wrap(newBuffer)"); // {{Aroush-2.9}}
//            }
...
//                            System.Diagnostics.Debug.WriteLine("Port issue:", "otherByteBuf = ByteBuffer.wrap(b)"); // {{Aroush-2.9}}
//                        }
//                        else
...
//                        System.Diagnostics.Debug.WriteLine("Port issue:", "bb = ByteBuffer.wrap(b, offset, len)"); // {{Aroush-2.9}}
//                    }
//                }
...
//                        System.Diagnostics.Debug.WriteLine("Port issue:", "channel.Read(bb, pos, limit)"); // {{Aroush-2.9}}
//                        if (i == - 1)
//                        {
