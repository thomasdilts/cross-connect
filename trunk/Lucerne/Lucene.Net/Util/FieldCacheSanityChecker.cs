...
namespace Lucene.Net.Util
{
	...
	public sealed class FieldCacheSanityChecker
	{
		...
		{
			System.Collections.IList all = new System.Collections.Generic.List<object>(17); // will grow as we iter
			all.Add(seed);
			...
			return (System.Collections.IList) ((System.Collections.Generic.List<object>) all).GetRange(1, all.Count - 1);
		}
