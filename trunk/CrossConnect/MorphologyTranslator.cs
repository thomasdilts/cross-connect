...
namespace CrossConnect
{
    ...
    public static class MorphologyTranslator
    {
        ...
        private static readonly Dictionary<string, string> Number = new Dictionary<string, string>
                                                                        {
                                                                            {"S", "Singular"},
                                                                            {"P", "Plural"},
                                                                        };
        private static readonly Dictionary<string, string> Person = new Dictionary<string, string>
                                                                        {
                                                                            {"1", "First person"},
                                                                            {"2", "Second person"},
                                                                            {"3", "Third person"}
        ...
        private static readonly Dictionary<string, string> Suffixes = new Dictionary<string, string>
                                                                          {
                                                                              ...
                                                                              {
                                                                                  "K",
                                                                                  "Contracted form, or two words merged by crasis"
                                                                                  },
                                                                              {"ATT", "Attic Greek form"},
                                                                              {
                                                                                  "P",
                                                                                  "Particle attached (with relative pronoun)"
                                                                                  }
                                                                          };
        ...
        private static readonly Dictionary<string, string> VerbTense = new Dictionary<string, string>
                                                                           {
                                                                               ...
                                                                               {
                                                                                   "X",
                                                                                   "No tense stated (adverbial imperative)"
                                                                                   },
                                                                           };
        ...
        public static string ParseRobinson(string toParse)
        {
            ...
            try
            {
                ...
                {
                    retInfo +=
                        Translations.Translate("Morphology-" +
                                               UndeclinedForms[pieces[0] + "-" + pieces[1]].DescriptiveText) + "\n";
                    retInfo +=
