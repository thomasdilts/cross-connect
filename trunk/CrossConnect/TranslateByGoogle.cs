// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TranslateByGoogle.cs" company="">
//   
// </copyright>
// <summary>
//   The translate by google.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace CrossConnect
{
    ...
    public class TranslateByGoogle
    {
        ...
        /// <summary>
        /// The _end user final translation event.
        /// </summary>
        private GoogleTranslatedTextReturnEvent _endUserFinalTranslationEvent;

        /// <summary>
        /// The _google translate from language.
        /// </summary>
        ...
        /// <summary>
        /// The google translated text return event.
        /// </summary>
        ...
        /// <summary>
        /// The get google translation async.
        /// </summary>
        /// <param name="textToGooleTranslate">
        /// The text to goole translate.
        /// </param>
        /// <param name="googleTranslateFromLanguage">
        /// The google translate from language.
        /// </param>
        /// <param name="endUserFinalTranslationEvent">
        /// The end user final translation event.
        /// </param>
        public void GetGoogleTranslationAsync(
            string textToGooleTranslate, 
            string googleTranslateFromLanguage, 
            GoogleTranslatedTextReturnEvent endUserFinalTranslationEvent)
        {
            this._endUserFinalTranslationEvent += endUserFinalTranslationEvent;
            this._textToGooleTranslate = textToGooleTranslate;
            this._googleTranslateFromLanguage = googleTranslateFromLanguage;
            try
            {
                this._proxy = new WebClient();
                this._proxy.OpenReadCompleted += this.OpenReadFromCrossConnectCompleted;

                string crossconnectUrl = string.Format(
                    CrossconnectUrl, App.DisplaySettings.UserUniqueGuuid, Translations.IsoLanguageCode);
                this._proxy.OpenReadAsync(new Uri(crossconnectUrl));
            }
            catch (Exception eee)
            {
        ...
        /// <summary>
        /// The download string from google completed.
        /// </summary>
        /// <param name="sender">
        /// The sender.
        /// </param>
        ...
        private void DownloadStringFromGoogleCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            try
            {
                ...
                string unEscapedText =
                    HttpUtility.HtmlDecode(
                        this.jsonUnescape(Regex.Match(e.Result, "\"translatedText\" *: *\"(.*?)\"").Groups[1].Value));
                this.ReplyToTranslateRequestor(unEscapedText, false);
            }
            catch (Exception ee2)
            {
                this.ReplyToTranslateRequestor(
        ...
        /// <summary>
        /// The open read from cross connect completed.
        /// </summary>
        /// <param name="sender">
        /// The sender.
        /// </param>
        ...
        private void OpenReadFromCrossConnectCompleted(object sender, OpenReadCompletedEventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(googleApiKey) || maxtranssize == 0)
                {
                    ...
                    {
                        this.ReplyToTranslateRequestor(msgFromServer, true);
                    }
                }
                else
                {
                    this._proxy = new WebClient();
                    this._proxy.DownloadStringCompleted += this.DownloadStringFromGoogleCompleted;
                    string toTranslate = Uri.EscapeDataString(this._textToGooleTranslate);
                    string googleTranslateUrl = string.Format(
                        ServiceUrl, 
                        googleApiKey, 
                        this._googleTranslateFromLanguage, 
                        Translations.IsoLanguageCode, 
                        toTranslate);
                    googleTranslateUrl = googleTranslateUrl.Substring(
                        0, googleTranslateUrl.Length > maxtranssize ? maxtranssize : googleTranslateUrl.Length);
                    this._proxy.DownloadStringAsync(new Uri(googleTranslateUrl));
        ...
        /// <summary>
        /// The reply to translate requestor.
        /// </summary>
        /// <param name="msg">
        /// The msg.
        /// </param>
        ...
        {
            if (this._endUserFinalTranslationEvent != null)
            {
                this._endUserFinalTranslationEvent(msg, isFail);
            }
        }
