...
namespace CrossConnect
{
    public class Theme
    {
        ...
        public Dictionary<Guid, Theme> Themes = new Dictionary<Guid, Theme>();
        ...
        public Guid CurrentTheme
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    FontFamily = ((FontFamily)Application.Current.Resources["PhoneFontFamilyNormal"]).ToString();
        ...
        public static Dictionary<string, string> FontFamilies = new Dictionary<string, string>
        {
            ...
            {"Avant Garde Gothic", "font-family: 'Century Gothic','Avant Garde Gothic','Avant Garde','URW Gothic L',helvetica,sans-serif;"},
