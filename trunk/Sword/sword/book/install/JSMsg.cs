...
namespace book.install
{
	...
	/// 
	public class JSMsg// : org.crosswire.common.util.MsgBase
	{
	///    
	...
	///     
		public static string gettext(string key, params object[] paramsIn)
		{
            string msg;
        ...
        private static JavaProperties messages = new JavaProperties("JSMsg",true);
