...
namespace javaprops
{
    ...
    public class JavaPropertyReader
    {
        ...
        /// <summary>
        /// Construct a reader passing a reference to a Dictionary<string,string> (or JavaProperties) instance
        /// where the keys are to be stored.
        /// </summary>
        /// <param name="dictionary">A reference to a Dictionary<string,string> where the key-value pairs can be stored.</param>
        ...
        private void doAction( int action, int ch )
        {
            switch( action )
            {
                ...
                // Debug.WriteLine( keyBuilder.ToString() + "=" + valueBuilder.ToString() );
                    dictionary[keyBuilder.ToString()]= valueBuilder.ToString() ;
                    keyBuilder.Length = 0;
