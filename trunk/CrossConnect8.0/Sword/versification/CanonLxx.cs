...
namespace Sword.versification
{
    ...
    class CanonLxx : Canon
    {
        private CanonBookDef[] _OldTestBooks =
        {
            ...
            new CanonBookDef("III Maccabees", "3Macc", "3Macc", 7),
            new CanonBookDef("IV Maccabees", "4Macc", "4Macc", 18),
            new CanonBookDef("Psalms", "Ps", "Ps", 151),
            ...
            new CanonBookDef("Psalms of Solomon", "PssSol", "PssSol", 18),
            ...
            new CanonBookDef("Baruch", "Bar", "Bar", 5),
            new CanonBookDef("Lamentations", "Lam", "Lam", 5),
            new CanonBookDef("Epistle of Jeremiah", "EpJer", "EpJer", 1),
            new CanonBookDef("Ezekiel", "Ezek", "Ezek", 48),
            new CanonBookDef("Prayer of Azariah", "PrAzar", "PrAzar", 1),
            new CanonBookDef("Susanna", "Sus", "Sus", 1),
            new CanonBookDef("Daniel", "Dan", "Dan", 12),
            new CanonBookDef("Bel and the Dragon", "Bel", "Bel", 1),
            new CanonBookDef("I Enoch", "1En", "1En", 108),
            new CanonBookDef("Odes", "Odes", "Odes", 14)
        };
