...
{
    public class BackupRestoreSdCard : IBackupRestore
    {
        #region Methods
        ...
        public async Task DoExport(BackupRestore.BackupManifest manifest, string crossConnectFolder, BackupRestoreConstants.Progress progressCallback)
        {
            ...
            try
            {
                ...
                var externRootFolder = await GetRootFolder();

                var deleteConnectFolder = await externRootFolder.GetFolderAsync(crossConnectFolder);
                if(deleteConnectFolder!=null)
                {
                    //deleteConnectFolder.del
                }/*
        ...
        private async Task<ExternalStorageFolder> GetRootFolder()
        {
        ...
        private async Task<Dictionary<string, string>[]> GetRootContents(string crossConnectFolder)
        {
            ...
            */
            return new Dictionary<string, string>[] { new Dictionary<string, string>(), new Dictionary<string, string>() };
        }
