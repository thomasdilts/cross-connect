    ...
    */
	...
	///     
		public string ConfPath
		{
			get
			{
				return SwordConstants.DIR_CONF + '/' + Initials.ToLower() + SwordConstants.EXTENSION_CONF;
			}
		}
		...
		public Uri Library
		{
			set
			{
				...
				cet.add(ConfigEntryType.LIBRARY_URL, value.ToString());
				base.Library = value;
				...
				URI location = NetUtil.lengthenURI(value, datapath);
		 ...
		 */
        /*
		public override Document toOSIS()
		{
