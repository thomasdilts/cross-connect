...
namespace Sword.versification
{
    ...
    // Because Bibles employing the Vulgate versification system, including different versions 
    // of the Vulgate itself, differ subtly in versification, this is not based on any single 
    // edition of the Vulgate, but on myriad editions on the Vulgate and translations of the Vulgate, 
    // electronic and print. The intention in creating this versification system was to encompas all 
    // of those editions so that none of them would require that verses be appended to verses within 
    // the versification system. As such, it is probable that every Bible will contain some empty 
    // verses (and most will have empty books). This versification system is explicitly NOT intended 
    ...
    class CanonVulg : Canon
    {
        private CanonBookDef[] _OldTestBooks =
        {
            ...
            new CanonBookDef("Esther", "Esth", "Esth", 16),
            ...
            new CanonBookDef("Daniel", "Dan", "Dan", 14),
        ...
        private CanonBookDef[] _NewTestBooks =
        {
            ...
            new CanonBookDef("I Esdras", "1Esd", "1Esd", 9),
            new CanonBookDef("II Esdras", "2Esd", "2Esd", 16),
            new CanonBookDef("Additional Psalm", "AddPs", "AddPs", 1),
            new CanonBookDef("Laodiceans", "EpLao", "EpLao", 1)
        };
