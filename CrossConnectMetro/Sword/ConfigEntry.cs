...
namespace Sword
{
    ...
    public class ConfigEntry
    {
        ...
        {
            this._name = aName;
            this._type = ConfigEntryType.FromString(aName);
        }
        ...
        public void AddValue(string val)
        {
            ...
            if (this._type != null)
            {
                aValue = this._type.Filter(aValue);
            }

            // Report on fields that shouldn't have RTF but do
            if (!this.AllowsRtf() && RtfPattern.IsMatch(aValue))
            {
            ...
            else
            {
                ...
                {
                    // histogram.increment(confEntryName);
                    if (this._type != null && this._type.HasChoices())
                    {
                        // histogram.increment(confEntryName + '.' + aValue);
                    }
                    if (!this.IsAllowed(aValue))
                    ...
                    if (this._type != null)
                    {
                        this._value = this._type.Convert(aValue);
                    }
                }
            }
        }
        ...
        public bool AllowsContinuation()
        {
            if (this._type != null)
            {
                return this._type.AllowsContinuation();
            }
            return true;
        }
        ...
        */
        ...
        public bool IsAllowed(string aValue)
        {
            if (this._type != null)
            {
                return this._type.IsAllowed(aValue);
            }
            return true;
        }
        ...
        public bool Match(object search)
        {
            if (this._value != null)
            {
                return this._value.Equals(search);
            }
            if (this._values != null)
            {
                return this._values.Contains(search.ToString());
            }
            object def = this._type.Default;
        ...
        public bool ReportDetails()
        {
            if (this._type != null)
            {
                return this._type.ReportDetails();
            }
            return true;
        }
        ...
        public string ToConf()
        {
            ...
            if (this._value != null)
            {
                ...
                buf.Append('=');
                string text = this.GetConfValue(this._value);
            ...
            else if (this._type.Equals(ConfigEntryType.CipherKey))
            {
            ...
            if (this._values != null)
            {
                ...
                if (this._type.Equals(ConfigEntryType.History))
                {
                    foreach (string text in this._values)
                    {
                        ...
                        {
                            buf.Append(
                                text.Substring(0, text.IndexOf(' ') - 1) + "=" + text.Substring(text.IndexOf(' ') + 1));
                        }
                        buf.Append('\n');
                    }
                }
        ...
        private string GetConfValue(object aValue)
        {
            if (aValue != null)
            {
                ...
                {
                    return ((Language)this._value).Code;
                }
