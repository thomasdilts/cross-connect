    ...
    public class JavaPropertyReader
    {
        ...
        private static readonly int[][] States = new[]
                                                     {
                                                         new[]
                                                             {
                                                                 ...
                                                                 StateComment, ActionIgnore, '!', StateComment,
                                                                 ActionIgnore, MatchWhitespace, StateStart,
                                                                 ActionIgnore, '\\', StateKeyEscape, ActionEscape, ':'
                                                                 , StateAfterSeparator, ActionIgnore, '=',
                                                                 StateAfterSeparator, ActionIgnore, MatchAny, StateKey
                                                                 , ActionAddToKey
                                                             },
                                                         new[]
                                                             {
                                                                 //STATE_comment
                                                                 MatchEndOfInput, StateFinish, ActionIgnore,
                                                                 MatchTerminator, StateStart, ActionIgnore, MatchAny,
                                                         ...
                                                         new[]
                                                             {
                                                                 //STATE_key_escape
                                                                 MatchTerminator, StateKeyWs, ActionIgnore, MatchAny,
                                                                 StateKey, ActionAddToKey
                                                             },
                                                         new[]
                                                             {
                                                                 //STATE_key_ws
                                                         ...
                                                         new[]
                                                             {
                                                                 ...
                                                                 StateAfterSeparator, ActionIgnore, '=',
                                                                 StateAfterSeparator, ActionIgnore, MatchAny,
                                                                 StateValue, ActionAddToValue
                                                             },
                                                         new[]
                                                             {
                                                                 ...
                                                                 '\\', StateValueEscape, ActionEscape, MatchAny,
                                                                 StateValue, ActionAddToValue
                                                             },
                                                         new[]
                                                             {
                                                         ...
                                                         new[]
                                                             {
                                                                 //STATE_value_escape
                                                                 MatchTerminator, StateValueWs, ActionIgnore, MatchAny
                                                                 , StateValue, ActionAddToValue
                                                             },
                                                         new[]
                                                             {
                                                                 ...
                                                                 StateValueEscape, ActionEscape, MatchAny, StateValue,
                                                                 ActionAddToValue
                                                             }
                                                     };
        ...
        public void Parse(Stream stream)
        {
            ...
            do
            {
                ...
                {
                    if (this.Matches(States[state][s], ch))
                    {
                        // Debug.WriteLine( stateNames[ state ] + ", " + (s/3) + ", " + ch + (ch>20?" (" + (char) ch + ")" : "") );
                        matched = true;
                        this.DoAction(States[state][s + 2], ch);
        ...
        private void DoAction(int action, int ch)
        {
            ...
            {
                case ActionAddToKey:
                    this._keyBuilder.Append(this.EscapedChar(ch));
                    this._escaped = false;
                    break;

                case ActionAddToValue:
                    this._valueBuilder.Append(this.EscapedChar(ch));
                    this._escaped = false;
                    break;

                case ActionStoreProperty:
                    // Debug.WriteLine( keyBuilder.ToString() + "=" + valueBuilder.ToString() );
                    this._dictionary[this._keyBuilder.ToString()] = this._valueBuilder.ToString();
                    this._keyBuilder.Length = 0;
                    this._valueBuilder.Length = 0;
                    this._escaped = false;
                    break;
            ...
            switch (match)
            {
                ...
                case MatchTerminator:
                    if (ch == '\r')
                    {
                        if (this.PeekChar() == '\n')
                        {
                            this.NextChar(); // consume the character
                        }
                        return true;
                    }
                    if (ch == '\n')
        ...
        private int NextChar()
        {
            ...
            if (this._reader.Read(nextC, 0, 1) == 0)
            {
                return -1;
            }
            return nextC[0];
